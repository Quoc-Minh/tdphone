        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('Repairing') }}</h4>
                        </div>
                        <div class="card-body">
                            <div id="table-roles" class="table-responsive">
                                <table class="table">
                                    ...
                                    @foreach ($repairing as $key => $receipt)
                                        <tr>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('Repaired') }}</h4>
                        </div>
                        <div class="card-body">
                            <div id="table-roles" class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <button class="table-sort" data-sort="sort-date">{{ __('receive time') }}</button>
                                        </th>
                                        <th>
                                            <button class="table-sort" data-sort="sort-date">{{ __('appointment time') }}</button>
                                        </th>
                                        <th>
                                            <button class="table-sort" data-sort="sort-receive">{{ __('status') }}</button>
                                        </th>
                                    ...
                                    <tbody class="table-tbody align-middle">
                                    @foreach ($repaired as $key => $receipt)
                                        <tr>
                                            <td class="sort-number">{{ $key+1 }}</td>
                                            <td class="sort-id">{{ $receipt->id }}</td>
                                            <td class="sort-receptionist">{{ $receipt->phieunhan->tenkhachhang }}</td>
