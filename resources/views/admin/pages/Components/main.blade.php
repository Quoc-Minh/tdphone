            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title text-uppercase">
                        {{ __('Components') }}
                        @can('Tạo linh kiện')
                            <a href="{{ route('admin.components.create') }}" class="btn btn-primary ms-auto">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('components') }}</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($components as $key => $component)
                                        <tr>
                                            ...
                                            @can('Cập nhật linh kiện')
                                                <td>
                                                    <a class="btn btn-ghost-primary" href="{{ route('admin.components.edit', ['id' => $component->id]) }}">{{ __('Edit') }}</a>
                                                </td>
                                            @endcan
                                            @can('Xóa linh kiện')
                                                <td>
                                                    <a href="{{ route('admin.components.delete',  ['id' => $component->id]) }}" class="btn btn-ghost-danger"
