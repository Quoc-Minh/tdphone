...
Route::middleware('localization')->group(function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::get('/repair-receipts/{id}/status/repaired', [RepairReceiptController::class, 'repaired'])->name('admin.repair-receipts.status.repaired');
        Route::get('/repair-receipts/{id}/status/cancel', [RepairReceiptController::class, 'cancel'])->name('admin.repair-receipts.status.cancel');
